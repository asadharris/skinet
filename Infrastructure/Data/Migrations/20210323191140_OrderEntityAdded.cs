    ...
    public partial class OrderEntityAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryMeathods", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryMeathodId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_DeliveryMeathods_DeliveryMeathodId",
                        column: x => x.DeliveryMeathodId,
                        principalTable: "DeliveryMeathods",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DeliveryMeathodId",
                table: "Orders",
                column: "DeliveryMeathodId");
        }
